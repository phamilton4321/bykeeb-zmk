# ZMK Firmware for bykeeb keyboard

This is a repository for a ZMK Firmware for bykeeb keyboard.
...
![Keymap Representation](./keymap-drawer/bykeeb.svg?raw=true "Keymap Representation")
...
1. Make changes to the [bykeeb.keymap](boards/shields/bykeeb/bykeeb.keymap) file using your favorite text editor.
...
2. Unzip `firmware.zip` - you should have `bykeeb_left-seeeduino_xiao_ble-zmk.uf2` and `bykeeb_right-seeeduino_xiao_ble-zmk.uf2` files
